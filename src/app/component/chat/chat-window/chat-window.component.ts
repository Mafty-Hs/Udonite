...
import { ChatTabSettingComponent ,ChatWindowSetting } from '../chat-tab-setting/chat-tab-setting.component';
...
@Component({
  ...
  styleUrls: ['../../../common/component.common.css','../../../common/scroll-white.common.css','./chat-window.component.css','../chat-window.common.css','../chat-window.design.css']
})
